...
and the creation of
`Dependabot pull requests <https://github.com/zhmcclient/zhmc-os-forwarder/pulls?q=is%3Apr+label%3Adependencies+is%3Aopen>`_
to fix them.
...
look at the
`run of the backport workflow <https://github.com/zhmcclient/zhmc-os-forwarder/actions/workflows/backport.yml>`_
...
10. Verify the documentation on ReadTheDocs
    ...
    https://readthedocs.org/projects/zhmc-os-forwarder/builds/

    Then, perform the following verification:

    * Verify that https://zhmc-os-forwarder.readthedocs.io/ gets redirected to
...
11. Hide previous fix version on ReadTheDocs
    ...
    https://readthedocs.org/projects/zhmc-os-forwarder/versions/, select to
